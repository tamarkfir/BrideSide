...
export const BOOKLET_TEMPLATES = {
  highDecor: ["ספרון · עמוס בפרחים א", "ספרון · עמוס בפרחים ב", "ספרון · עמוס בפרחים ג"],
  mediumDecor: ["ספרון · מעט פרחים א", "ספרון · מעט פרחים ב", "ספרון · מעט פרחים ג"],
  lowDecor: ["ספרון · בלי פרחים כמעט א", "ספרון · בלי פרחים כמעט ב"]
};
